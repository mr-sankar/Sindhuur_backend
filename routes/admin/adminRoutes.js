    ...
    const profiles = users.map((user) => {
      ...
      return {
        ...
        premium:
          ...
          user.subscription?.current === "premium plus", // Explicitly handle 'premium' and 'premium plus'
        subscription: {
          current: user.subscription?.current || "free", // Handles 'free', 'premium', 'premium plus'
